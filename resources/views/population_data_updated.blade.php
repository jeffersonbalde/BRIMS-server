...
<html>
<head>
    <title>Population Data Updated</title>
</head>
<body>
    <h2>Population Data Updated by Administrator</h2>
    
    <p>Hello {{ $reporter->name }},</p>
    
    <p>An administrator has updated the population data for your incident report:</p>
